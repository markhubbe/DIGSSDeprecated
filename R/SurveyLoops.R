#' Survey Loops
#'
#' Perform multiple surveys changing values on one variable and plot results
#'
#' @details
...
#'  runs multiple instances of `SurveySim` from the values of `SurveyParameters` and overrided it with values offered by the user.
#'
...
#'
#' `grid.type` - vector of characters with names of grid types
#'
...
#' @examples
#' #Loop the impact of a increasing distance between survey rows
